...
public class DefaultProjectRequestToDescriptionConverter
    ...
    public void convert(ProjectRequest request, MutableProjectDescription description, InitializrMetadata metadata) {
        ...
        description.setJdbcHost(request.getJdbcHost());
        description.setJdbcPort(request.getJdbcPort());
        description.setJdbcDb(request.getJdbcDb());
        description.setJdbcUsername(request.getJdbcUsername());
        description.setJdbcPassword(request.getJdbcPassword());
